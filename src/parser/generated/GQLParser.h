...
public:
  ...
  enum {
    ...
    RuleCompositeQueryExpression = 92, RuleCompositeQueryExpressionFocused = 93, 
    RuleCompositeQueryExpressionAmbient = 94, RuleQueryConjunction = 95, 
    RuleSetOperator = 96, RuleCompositeQueryPrimary = 97, RuleLinearQueryStatement = 98, 
    RuleFocusedLinearQueryStatement = 99, RuleFocusedLinearQueryStatementPart = 100, 
    RuleFocusedLinearQueryAndPrimitiveResultStatementPart = 101, RuleFocusedPrimitiveResultStatement = 102, 
    RuleFocusedNestedQuerySpecification = 103, RuleAmbientLinearQueryStatement = 104, 
    RuleSimpleLinearQueryStatement = 105, RuleSimpleQueryStatement = 106, 
    RulePrimitiveQueryStatement = 107, RuleMatchStatement = 108, RuleSimpleMatchStatement = 109, 
    RuleOptionalMatchStatement = 110, RuleOptionalOperand = 111, RuleMatchStatementBlock = 112, 
    RuleCallQueryStatement = 113, RuleFilterStatement = 114, RuleLetStatement = 115, 
    RuleLetVariableDefinitionList = 116, RuleLetVariableDefinition = 117, 
    RuleForStatement = 118, RuleForItem = 119, RuleForItemAlias = 120, RuleForItemSource = 121, 
    RuleForOrdinalityOrOffset = 122, RuleOrderByAndPageStatement = 123, 
    RulePrimitiveResultStatement = 124, RuleReturnStatement = 125, RuleReturnStatementBody = 126, 
    RuleReturnItemList = 127, RuleReturnItem = 128, RuleReturnItemAlias = 129, 
    RuleSelectStatement = 130, RuleSelectItemList = 131, RuleSelectItem = 132, 
    RuleSelectItemAlias = 133, RuleHavingClause = 134, RuleSelectStatementBody = 135, 
    RuleSelectGraphMatchList = 136, RuleSelectGraphMatch = 137, RuleSelectQuerySpecification = 138, 
    RuleCallProcedureStatement = 139, RuleProcedureCall = 140, RuleInlineProcedureCall = 141, 
    RuleVariableScopeClause = 142, RuleBindingVariableReferenceList = 143, 
    RuleNamedProcedureCall = 144, RuleProcedureArgumentList = 145, RuleProcedureArgument = 146, 
    RuleAtSchemaClause = 147, RuleUseGraphClause = 148, RuleGraphPatternBindingTable = 149, 
    RuleGraphPatternYieldClause = 150, RuleGraphPatternYieldItemList = 151, 
    RuleGraphPatternYieldItem = 152, RuleGraphPattern = 153, RuleMatchMode = 154, 
    RuleRepeatableElementsMatchMode = 155, RuleDifferentEdgesMatchMode = 156, 
    RuleElementBindingsOrElements = 157, RuleEdgeBindingsOrEdges = 158, 
    RulePathPatternList = 159, RulePathPattern = 160, RulePathVariableDeclaration = 161, 
    RuleKeepClause = 162, RuleGraphPatternWhereClause = 163, RuleInsertGraphPattern = 164, 
    RuleInsertPathPatternList = 165, RuleInsertPathPattern = 166, RuleInsertNodePattern = 167, 
    RuleInsertEdgePattern = 168, RuleInsertEdgePointingLeft = 169, RuleInsertEdgePointingRight = 170, 
    RuleInsertEdgeUndirected = 171, RuleInsertElementPatternFiller = 172, 
    RuleLabelAndPropertySetSpecification = 173, RulePathPatternPrefix = 174, 
    RulePathModePrefix = 175, RulePathMode = 176, RulePathSearchPrefix = 177, 
    RuleAllPathSearch = 178, RulePathOrPaths = 179, RuleAnyPathSearch = 180, 
    RuleNumberOfPaths = 181, RuleShortestPathSearch = 182, RuleAllShortestPathSearch = 183, 
    RuleAnyShortestPathSearch = 184, RuleCountedShortestPathSearch = 185, 
    RuleCountedShortestGroupSearch = 186, RuleNumberOfGroups = 187, RulePathPatternExpression = 188, 
    RulePathTerm = 189, RulePathFactor = 190, RulePathPrimary = 191, RuleElementPattern = 192, 
    RuleNodePattern = 193, RuleElementPatternFiller = 194, RuleElementVariableDeclaration = 195, 
    RuleIsLabelExpression = 196, RuleIsOrColon = 197, RuleElementPatternPredicate = 198, 
    RuleElementPatternWhereClause = 199, RuleElementPropertySpecification = 200, 
    RulePropertyKeyValuePairList = 201, RulePropertyKeyValuePair = 202, 
    RuleEdgePattern = 203, RuleFullEdgePattern = 204, RuleFullEdgePointingLeft = 205, 
    RuleFullEdgeUndirected = 206, RuleFullEdgePointingRight = 207, RuleFullEdgeLeftOrUndirected = 208, 
    RuleFullEdgeUndirectedOrRight = 209, RuleFullEdgeLeftOrRight = 210, 
    RuleFullEdgeAnyDirection = 211, RuleAbbreviatedEdgePattern = 212, RuleParenthesizedPathPatternExpression = 213, 
    RuleSubpathVariableDeclaration = 214, RuleParenthesizedPathPatternWhereClause = 215, 
    RuleLabelExpression = 216, RulePathVariableReference = 217, RuleElementVariableReference = 218, 
    RuleGraphPatternQuantifier = 219, RuleFixedQuantifier = 220, RuleGeneralQuantifier = 221, 
    RuleLowerBound = 222, RuleUpperBound = 223, RuleSimplifiedPathPatternExpression = 224, 
    RuleSimplifiedDefaultingLeft = 225, RuleSimplifiedDefaultingUndirected = 226, 
    RuleSimplifiedDefaultingRight = 227, RuleSimplifiedDefaultingLeftOrUndirected = 228, 
    RuleSimplifiedDefaultingUndirectedOrRight = 229, RuleSimplifiedDefaultingLeftOrRight = 230, 
    RuleSimplifiedDefaultingAnyDirection = 231, RuleSimplifiedContents = 232, 
    RuleSimplifiedPathUnion = 233, RuleSimplifiedMultisetAlternation = 234, 
    RuleSimplifiedTerm = 235, RuleSimplifiedFactorLow = 236, RuleSimplifiedFactorHigh = 237, 
    RuleSimplifiedQuantified = 238, RuleSimplifiedQuestioned = 239, RuleSimplifiedTertiary = 240, 
    RuleSimplifiedDirectionOverride = 241, RuleSimplifiedOverrideLeft = 242, 
    RuleSimplifiedOverrideUndirected = 243, RuleSimplifiedOverrideRight = 244, 
    RuleSimplifiedOverrideLeftOrUndirected = 245, RuleSimplifiedOverrideUndirectedOrRight = 246, 
    RuleSimplifiedOverrideLeftOrRight = 247, RuleSimplifiedOverrideAnyDirection = 248, 
    RuleSimplifiedSecondary = 249, RuleSimplifiedNegation = 250, RuleSimplifiedPrimary = 251, 
    RuleWhereClause = 252, RuleYieldClause = 253, RuleYieldItemList = 254, 
    RuleYieldItem = 255, RuleYieldItemName = 256, RuleYieldItemAlias = 257, 
    RuleGroupByClause = 258, RuleGroupingElementList = 259, RuleGroupingElement = 260, 
    RuleEmptyGroupingSet = 261, RuleOrderByClause = 262, RuleSortSpecificationList = 263, 
    RuleSortSpecification = 264, RuleSortKey = 265, RuleOrderingSpecification = 266, 
    RuleNullOrdering = 267, RuleLimitClause = 268, RuleOffsetClause = 269, 
    RuleOffsetSynonym = 270, RuleSchemaReference = 271, RuleAbsoluteCatalogSchemaReference = 272, 
    RuleCatalogSchemaParentAndName = 273, RuleRelativeCatalogSchemaReference = 274, 
    RulePredefinedSchemaReference = 275, RuleAbsoluteDirectoryPath = 276, 
    RuleRelativeDirectoryPath = 277, RuleSimpleDirectoryPath = 278, RuleGraphReference = 279, 
    RuleCatalogGraphParentAndName = 280, RuleHomeGraph = 281, RuleGraphTypeReference = 282, 
    RuleCatalogGraphTypeParentAndName = 283, RuleBindingTableReference = 284, 
    RuleProcedureReference = 285, RuleCatalogProcedureParentAndName = 286, 
    RuleCatalogObjectParentReference = 287, RuleReferenceParameterSpecification = 288, 
    RuleNestedGraphTypeSpecification = 289, RuleGraphTypeSpecificationBody = 290, 
    RuleElementTypeList = 291, RuleElementTypeSpecification = 292, RuleNodeTypeSpecification = 293, 
    RuleNodeTypePattern = 294, RuleNodeTypePhrase = 295, RuleNodeTypePhraseFiller = 296, 
    RuleNodeTypeFiller = 297, RuleLocalNodeTypeAlias = 298, RuleNodeTypeImpliedContent = 299, 
    RuleNodeTypeKeyLabelSet = 300, RuleNodeTypeLabelSet = 301, RuleNodeTypePropertyTypes = 302, 
    RuleEdgeTypeSpecification = 303, RuleEdgeTypePattern = 304, RuleEdgeTypePhrase = 305, 
    RuleEdgeTypePhraseFiller = 306, RuleEdgeTypeFiller = 307, RuleEdgeTypeImpliedContent = 308, 
    RuleEdgeTypeKeyLabelSet = 309, RuleEdgeTypeLabelSet = 310, RuleEdgeTypePropertyTypes = 311, 
    RuleEdgeTypePatternDirected = 312, RuleEdgeTypePatternPointingRight = 313, 
    RuleEdgeTypePatternPointingLeft = 314, RuleEdgeTypePatternUndirected = 315, 
    RuleArcTypePointingRight = 316, RuleArcTypePointingLeft = 317, RuleArcTypeUndirected = 318, 
    RuleSourceNodeTypeReference = 319, RuleDestinationNodeTypeReference = 320, 
    RuleEdgeKind = 321, RuleEndpointPairPhrase = 322, RuleEndpointPair = 323, 
    RuleEndpointPairDirected = 324, RuleEndpointPairPointingRight = 325, 
    RuleEndpointPairPointingLeft = 326, RuleEndpointPairUndirected = 327, 
    RuleConnectorPointingRight = 328, RuleConnectorUndirected = 329, RuleSourceNodeTypeAlias = 330, 
    RuleDestinationNodeTypeAlias = 331, RuleLabelSetPhrase = 332, RuleLabelSetSpecification = 333, 
    RulePropertyTypesSpecification = 334, RulePropertyTypeList = 335, RulePropertyType = 336, 
    RulePropertyValueType = 337, RuleBindingTableType = 338, RuleValueType = 339, 
    RuleTyped = 340, RulePredefinedType = 341, RuleBooleanType = 342, RuleCharacterStringType = 343, 
    RuleByteStringType = 344, RuleMinLength = 345, RuleMaxLength = 346, 
    RuleFixedLength = 347, RuleNumericType = 348, RuleExactNumericType = 349, 
    RuleBinaryExactNumericType = 350, RuleSignedBinaryExactNumericType = 351, 
    RuleUnsignedBinaryExactNumericType = 352, RuleVerboseBinaryExactNumericType = 353, 
    RuleDecimalExactNumericType = 354, RulePrecision = 355, RuleScale = 356, 
    RuleApproximateNumericType = 357, RuleTemporalType = 358, RuleTemporalInstantType = 359, 
    RuleDatetimeType = 360, RuleLocaldatetimeType = 361, RuleDateType = 362, 
    RuleTimeType = 363, RuleLocaltimeType = 364, RuleTemporalDurationType = 365, 
    RuleTemporalDurationQualifier = 366, RuleReferenceValueType = 367, RuleImmaterialValueType = 368, 
    RuleNullType = 369, RuleEmptyType = 370, RuleGraphReferenceValueType = 371, 
    RuleClosedGraphReferenceValueType = 372, RuleOpenGraphReferenceValueType = 373, 
    RuleBindingTableReferenceValueType = 374, RuleNodeReferenceValueType = 375, 
    RuleClosedNodeReferenceValueType = 376, RuleOpenNodeReferenceValueType = 377, 
    RuleEdgeReferenceValueType = 378, RuleClosedEdgeReferenceValueType = 379, 
    RuleOpenEdgeReferenceValueType = 380, RulePathValueType = 381, RuleListValueTypeName = 382, 
    RuleListValueTypeNameSynonym = 383, RuleRecordType = 384, RuleFieldTypesSpecification = 385, 
    RuleFieldTypeList = 386, RuleNotNull = 387, RuleFieldType = 388, RuleSearchCondition = 389, 
    RulePredicate = 390, RuleCompOp = 391, RuleExistsPredicate = 392, RuleNullPredicate = 393, 
    RuleNullPredicatePart2 = 394, RuleValueTypePredicate = 395, RuleValueTypePredicatePart2 = 396, 
    RuleNormalizedPredicatePart2 = 397, RuleDirectedPredicate = 398, RuleDirectedPredicatePart2 = 399, 
    RuleLabeledPredicate = 400, RuleLabeledPredicatePart2 = 401, RuleIsLabeledOrColon = 402, 
    RuleSourceDestinationPredicate = 403, RuleNodeReference = 404, RuleSourcePredicatePart2 = 405, 
    RuleDestinationPredicatePart2 = 406, RuleEdgeReference = 407, RuleAll_differentPredicate = 408, 
    RuleSamePredicate = 409, RuleProperty_existsPredicate = 410, RuleValueExpression = 411, 
    RuleValueFunction = 412, RuleBooleanValueExpression = 413, RuleCharacterOrByteStringFunction = 414, 
    RuleSubCharacterOrByteString = 415, RuleTrimSingleCharacterOrByteString = 416, 
    RuleFoldCharacterString = 417, RuleTrimMultiCharacterCharacterString = 418, 
    RuleNormalizeCharacterString = 419, RuleNodeReferenceValueExpression = 420, 
    RuleEdgeReferenceValueExpression = 421, RuleAggregatingValueExpression = 422, 
    RuleValueExpressionPrimary = 423, RuleParenthesizedValueExpression = 424, 
    RuleNonParenthesizedValueExpressionPrimary = 425, RuleNonParenthesizedValueExpressionPrimarySpecialCase = 426, 
    RuleUnsignedValueSpecification = 427, RuleNonNegativeIntegerSpecification = 428, 
    RuleGeneralValueSpecification = 429, RuleDynamicParameterSpecification = 430, 
    RuleLetValueExpression = 431, RuleValueQueryExpression = 432, RuleCaseExpression = 433, 
    RuleCaseAbbreviation = 434, RuleCaseSpecification = 435, RuleSimpleCase = 436, 
    RuleSearchedCase = 437, RuleSimpleWhenClause = 438, RuleSearchedWhenClause = 439, 
    RuleElseClause = 440, RuleCaseOperand = 441, RuleWhenOperandList = 442, 
    RuleWhenOperand = 443, RuleResult = 444, RuleResultExpression = 445, 
    RuleCastSpecification = 446, RuleCastOperand = 447, RuleCastTarget = 448, 
    RuleAggregateFunction = 449, RuleGeneralSetFunction = 450, RuleBinarySetFunction = 451, 
    RuleGeneralSetFunctionType = 452, RuleSetQuantifier = 453, RuleBinarySetFunctionType = 454, 
    RuleDependentValueExpression = 455, RuleIndependentValueExpression = 456, 
    RuleElement_idFunction = 457, RuleBindingVariableReference = 458, RulePathValueExpression = 459, 
    RulePathValueConstructor = 460, RulePathValueConstructorByEnumeration = 461, 
    RulePathElementList = 462, RulePathElementListStart = 463, RulePathElementListStep = 464, 
    RuleListValueExpression = 465, RuleListValueFunction = 466, RuleTrimListFunction = 467, 
    RuleElementsFunction = 468, RuleListValueConstructor = 469, RuleListValueConstructorByEnumeration = 470, 
