...
public:
  ...
  enum {
    ...
    RulePgq_Alias = 64, RulePgq_catalogObjectParentReference = 65, RulePgq_elementName = 66, 
    RulePgq_elementKeys = 67, RulePgq_nodeElementKey = 68, RulePgq_edgeElementKeys = 69, 
    RulePgq_elementKey = 70, RulePgq_sourceKey = 71, RulePgq_destinationKey = 72, 
    RulePgq_edgeColumnNameList = 73, RulePgq_nodeColumnNameList = 74, RulePgq_columnNameList = 75, 
    RulePgq_columnName = 76, RulePgq_elementAliasReference = 77, RulePgq_labelAndPropertiesList = 78, 
    RulePgq_labelAndProperties = 79, RulePgq_elementLabel = 80, RulePgq_elementProperties = 81, 
    RulePgq_propertiesAre = 82, RulePgq_derivedPropertyList = 83, RulePgg_derivedProperty = 84, 
    RulePgq_dynamicLabel = 85, RulePgq_dynamicLabelColumnName = 86, RulePgq_dynamicProperties = 87, 
    RulePgq_dynamicPropertiesColumnName = 88, RuleOpenGraphType = 89, RuleOfGraphType = 90, 
    RuleGraphTypeLikeGraph = 91, RuleGraphSource = 92, RuleDropGraphStatement = 93, 
    RuleCreateGraphTypeStatement = 94, RuleGraphTypeSource = 95, RuleCopyOfGraphType = 96, 
    RuleDropGraphTypeStatement = 97, RuleCallCatalogModifyingProcedureStatement = 98, 
    RuleLinearDataModifyingStatement = 99, RuleFocusedLinearDataModifyingStatement = 100, 
    RuleFocusedLinearDataModifyingStatementBody = 101, RuleFocusedNestedDataModifyingProcedureSpecification = 102, 
    RuleAmbientLinearDataModifyingStatement = 103, RuleAmbientLinearDataModifyingStatementBody = 104, 
    RuleSimpleLinearDataAccessingStatement = 105, RuleSimpleDataAccessingStatement = 106, 
    RuleSimpleDataModifyingStatement = 107, RulePrimitiveDataModifyingStatement = 108, 
    RuleInsertStatement = 109, RuleSetStatement = 110, RuleSetItemList = 111, 
    RuleSetItem = 112, RuleSetPropertyItem = 113, RuleSetAllPropertiesItem = 114, 
    RuleSetLabelItem = 115, RuleRemoveStatement = 116, RuleRemoveItemList = 117, 
    RuleRemoveItem = 118, RuleRemovePropertyItem = 119, RuleRemoveLabelItem = 120, 
    RuleDeleteStatement = 121, RuleDeleteItemList = 122, RuleDeleteItem = 123, 
    RuleCallDataModifyingProcedureStatement = 124, RuleCompositeQueryStatement = 125, 
    RuleCompositeQueryExpression = 126, RuleCompositeQueryExpressionFocused = 127, 
    RuleCompositeQueryExpressionAmbient = 128, RuleQueryConjunction = 129, 
    RuleSetOperator = 130, RuleCompositeQueryPrimary = 131, RuleLinearQueryStatement = 132, 
    RuleFocusedLinearQueryStatement = 133, RuleFocusedLinearQueryStatementPart = 134, 
    RuleFocusedLinearQueryAndPrimitiveResultStatementPart = 135, RuleFocusedPrimitiveResultStatement = 136, 
    RuleFocusedNestedQuerySpecification = 137, RuleAmbientLinearQueryStatement = 138, 
    RuleSimpleLinearQueryStatement = 139, RuleSimpleQueryStatement = 140, 
    RulePrimitiveQueryStatement = 141, RuleMatchStatement = 142, RuleSimpleMatchStatement = 143, 
    RuleOptionalMatchStatement = 144, RuleOptionalOperand = 145, RuleMatchStatementBlock = 146, 
    RuleCallQueryStatement = 147, RuleFilterStatement = 148, RuleLetStatement = 149, 
    RuleLetVariableDefinitionList = 150, RuleLetVariableDefinition = 151, 
    RuleForStatement = 152, RuleForItem = 153, RuleForItemAlias = 154, RuleForItemSource = 155, 
    RuleForOrdinalityOrOffset = 156, RuleOrderByAndPageStatement = 157, 
    RulePrimitiveResultStatement = 158, RuleReturnStatement = 159, RuleReturnStatementBody = 160, 
    RuleReturnItemList = 161, RuleReturnItem = 162, RuleReturnItemAlias = 163, 
    RuleSelectStatement = 164, RuleSelectItemList = 165, RuleSelectItem = 166, 
    RuleSelectItemAlias = 167, RuleHavingClause = 168, RuleSelectStatementBody = 169, 
    RuleSelectGraphMatchList = 170, RuleSelectGraphMatch = 171, RuleSelectQuerySpecification = 172, 
    RuleCallProcedureStatement = 173, RuleProcedureCall = 174, RuleInlineProcedureCall = 175, 
    RuleVariableScopeClause = 176, RuleBindingVariableReferenceList = 177, 
    RuleNamedProcedureCall = 178, RuleProcedureArgumentList = 179, RuleProcedureArgument = 180, 
    RuleAtSchemaClause = 181, RuleUseGraphClause = 182, RuleGraphPatternBindingTable = 183, 
    RuleGraphPatternYieldClause = 184, RuleGraphPatternYieldItemList = 185, 
    RuleGraphPatternYieldItem = 186, RuleGraphPattern = 187, RuleMatchMode = 188, 
    RuleRepeatableElementsMatchMode = 189, RuleDifferentEdgesMatchMode = 190, 
    RuleElementBindingsOrElements = 191, RuleEdgeBindingsOrEdges = 192, 
    RulePathPatternList = 193, RulePathPattern = 194, RulePathVariableDeclaration = 195, 
    RuleKeepClause = 196, RuleGraphPatternWhereClause = 197, RuleInsertGraphPattern = 198, 
    RuleInsertPathPatternList = 199, RuleInsertPathPattern = 200, RuleInsertNodePattern = 201, 
    RuleInsertEdgePattern = 202, RuleInsertEdgePointingLeft = 203, RuleInsertEdgePointingRight = 204, 
    RuleInsertEdgeUndirected = 205, RuleInsertElementPatternFiller = 206, 
    RuleLabelAndPropertySetSpecification = 207, RulePathPatternPrefix = 208, 
    RulePathModePrefix = 209, RulePathMode = 210, RulePathSearchPrefix = 211, 
    RuleAllPathSearch = 212, RulePathOrPaths = 213, RuleAnyPathSearch = 214, 
    RuleNumberOfPaths = 215, RuleShortestPathSearch = 216, RuleAllShortestPathSearch = 217, 
    RuleAnyShortestPathSearch = 218, RuleCountedShortestPathSearch = 219, 
    RuleCountedShortestGroupSearch = 220, RuleNumberOfGroups = 221, RulePathPatternExpression = 222, 
    RulePathTerm = 223, RulePathFactor = 224, RulePathPrimary = 225, RuleElementPattern = 226, 
    RuleNodePattern = 227, RuleElementPatternFiller = 228, RuleElementVariableDeclaration = 229, 
    ...
    RuleLabelExpression = 250, RulePathVariableReference = 251, RuleElementVariableReference = 252, 
    RuleGraphPatternQuantifier = 253, RuleFixedQuantifier = 254, RuleGeneralQuantifier = 255, 
    RuleLowerBound = 256, RuleUpperBound = 257, RuleSimplifiedPathPatternExpression = 258, 
    RuleSimplifiedDefaultingLeft = 259, RuleSimplifiedDefaultingUndirected = 260, 
    RuleSimplifiedDefaultingRight = 261, RuleSimplifiedDefaultingLeftOrUndirected = 262, 
    RuleSimplifiedDefaultingUndirectedOrRight = 263, RuleSimplifiedDefaultingLeftOrRight = 264, 
    RuleSimplifiedDefaultingAnyDirection = 265, RuleSimplifiedContents = 266, 
    RuleSimplifiedPathUnion = 267, RuleSimplifiedMultisetAlternation = 268, 
    RuleSimplifiedTerm = 269, RuleSimplifiedFactorLow = 270, RuleSimplifiedFactorHigh = 271, 
    RuleSimplifiedQuantified = 272, RuleSimplifiedQuestioned = 273, RuleSimplifiedTertiary = 274, 
    RuleSimplifiedDirectionOverride = 275, RuleSimplifiedOverrideLeft = 276, 
    RuleSimplifiedOverrideUndirected = 277, RuleSimplifiedOverrideRight = 278, 
    RuleSimplifiedOverrideLeftOrUndirected = 279, RuleSimplifiedOverrideUndirectedOrRight = 280, 
    RuleSimplifiedOverrideLeftOrRight = 281, RuleSimplifiedOverrideAnyDirection = 282, 
    RuleSimplifiedSecondary = 283, RuleSimplifiedNegation = 284, RuleSimplifiedPrimary = 285, 
    RuleWhereClause = 286, RuleYieldClause = 287, RuleYieldItemList = 288, 
    RuleYieldItem = 289, RuleYieldItemName = 290, RuleYieldItemAlias = 291, 
    RuleGroupByClause = 292, RuleGroupingElementList = 293, RuleGroupingElement = 294, 
    RuleEmptyGroupingSet = 295, RuleOrderByClause = 296, RuleSortSpecificationList = 297, 
    RuleSortSpecification = 298, RuleSortKey = 299, RuleOrderingSpecification = 300, 
    RuleNullOrdering = 301, RuleLimitClause = 302, RuleOffsetClause = 303, 
    RuleOffsetSynonym = 304, RuleSchemaReference = 305, RuleAbsoluteCatalogSchemaReference = 306, 
    RuleCatalogSchemaParentAndName = 307, RuleRelativeCatalogSchemaReference = 308, 
    RulePredefinedSchemaReference = 309, RuleAbsoluteDirectoryPath = 310, 
    RuleRelativeDirectoryPath = 311, RuleSimpleDirectoryPath = 312, RuleGraphReference = 313, 
    RuleCatalogGraphParentAndName = 314, RuleHomeGraph = 315, RuleGraphTypeReference = 316, 
    RuleCatalogGraphTypeParentAndName = 317, RuleBindingTableReference = 318, 
    RuleProcedureReference = 319, RuleCatalogProcedureParentAndName = 320, 
    RuleCatalogObjectParentReference = 321, RuleReferenceParameterSpecification = 322, 
    RuleNestedGraphTypeSpecification = 323, RuleGraphTypeSpecificationBody = 324, 
    RuleElementTypeList = 325, RuleElementTypeSpecification = 326, RuleNodeTypeSpecification = 327, 
    RuleNodeTypePattern = 328, RuleNodeTypePhrase = 329, RuleNodeTypePhraseFiller = 330, 
    RuleNodeTypeFiller = 331, RuleLocalNodeTypeAlias = 332, RuleNodeTypeImpliedContent = 333, 
    RuleNodeTypeKeyLabelSet = 334, RuleNodeTypeLabelSet = 335, RuleNodeTypePropertyTypes = 336, 
    RuleEdgeTypeSpecification = 337, RuleEdgeTypePattern = 338, RuleEdgeTypePhrase = 339, 
    RuleEdgeTypePhraseFiller = 340, RuleEdgeTypeFiller = 341, RuleEdgeTypeImpliedContent = 342, 
    RuleEdgeTypeKeyLabelSet = 343, RuleEdgeTypeLabelSet = 344, RuleEdgeTypePropertyTypes = 345, 
    RuleEdgeTypePatternDirected = 346, RuleEdgeTypePatternPointingRight = 347, 
    RuleEdgeTypePatternPointingLeft = 348, RuleEdgeTypePatternUndirected = 349, 
    RuleArcTypePointingRight = 350, RuleArcTypePointingLeft = 351, RuleArcTypeUndirected = 352, 
    RuleSourceNodeTypeReference = 353, RuleDestinationNodeTypeReference = 354, 
    RuleEdgeKind = 355, RuleEndpointPairPhrase = 356, RuleEndpointPair = 357, 
    RuleEndpointPairDirected = 358, RuleEndpointPairPointingRight = 359, 
    RuleEndpointPairPointingLeft = 360, RuleEndpointPairUndirected = 361, 
    RuleConnectorPointingRight = 362, RuleConnectorUndirected = 363, RuleSourceNodeTypeAlias = 364, 
    RuleDestinationNodeTypeAlias = 365, RuleLabelSetPhrase = 366, RuleLabelSetSpecification = 367, 
    RulePropertyTypesSpecification = 368, RulePropertyTypeList = 369, RulePropertyType = 370, 
    RulePropertyValueType = 371, RuleBindingTableType = 372, RuleValueType = 373, 
    RuleTyped = 374, RulePredefinedType = 375, RuleBooleanType = 376, RuleCharacterStringType = 377, 
    RuleByteStringType = 378, RuleMinLength = 379, RuleMaxLength = 380, 
    RuleFixedLength = 381, RuleNumericType = 382, RuleExactNumericType = 383, 
    ...
    RuleDatetimeType = 394, RuleLocaldatetimeType = 395, RuleDateType = 396, 
    RuleTimeType = 397, RuleLocaltimeType = 398, RuleTemporalDurationType = 399, 
    RuleTemporalDurationQualifier = 400, RuleReferenceValueType = 401, RuleImmaterialValueType = 402, 
    RuleNullType = 403, RuleEmptyType = 404, RuleGraphReferenceValueType = 405, 
    RuleClosedGraphReferenceValueType = 406, RuleOpenGraphReferenceValueType = 407, 
    RuleBindingTableReferenceValueType = 408, RuleNodeReferenceValueType = 409, 
    RuleClosedNodeReferenceValueType = 410, RuleOpenNodeReferenceValueType = 411, 
    RuleEdgeReferenceValueType = 412, RuleClosedEdgeReferenceValueType = 413, 
    RuleOpenEdgeReferenceValueType = 414, RulePathValueType = 415, RuleListValueTypeName = 416, 
    RuleListValueTypeNameSynonym = 417, RuleRecordType = 418, RuleFieldTypesSpecification = 419, 
    RuleFieldTypeList = 420, RuleNotNull = 421, RuleFieldType = 422, RuleSearchCondition = 423, 
    RulePredicate = 424, RuleCompOp = 425, RuleExistsPredicate = 426, RuleNullPredicate = 427, 
    RuleNullPredicatePart2 = 428, RuleValueTypePredicate = 429, RuleValueTypePredicatePart2 = 430, 
    RuleNormalizedPredicatePart2 = 431, RuleDirectedPredicate = 432, RuleDirectedPredicatePart2 = 433, 
    RuleLabeledPredicate = 434, RuleLabeledPredicatePart2 = 435, RuleIsLabeledOrColon = 436, 
    RuleSourceDestinationPredicate = 437, RuleNodeReference = 438, RuleSourcePredicatePart2 = 439, 
    RuleDestinationPredicatePart2 = 440, RuleEdgeReference = 441, RuleAll_differentPredicate = 442, 
    RuleSamePredicate = 443, RuleProperty_existsPredicate = 444, RuleValueExpression = 445, 
    RuleValueFunction = 446, RuleBooleanValueExpression = 447, RuleCharacterOrByteStringFunction = 448, 
    RuleSubCharacterOrByteString = 449, RuleTrimSingleCharacterOrByteString = 450, 
    RuleFoldCharacterString = 451, RuleTrimMultiCharacterCharacterString = 452, 
    RuleNormalizeCharacterString = 453, RuleNodeReferenceValueExpression = 454, 
    RuleEdgeReferenceValueExpression = 455, RuleAggregatingValueExpression = 456, 
    RuleValueExpressionPrimary = 457, RuleParenthesizedValueExpression = 458, 
    RuleNonParenthesizedValueExpressionPrimary = 459, RuleNonParenthesizedValueExpressionPrimarySpecialCase = 460, 
    RuleUnsignedValueSpecification = 461, RuleNonNegativeIntegerSpecification = 462, 
    RuleGeneralValueSpecification = 463, RuleDynamicParameterSpecification = 464, 
    RuleLetValueExpression = 465, RuleValueQueryExpression = 466, RuleCaseExpression = 467, 
    RuleCaseAbbreviation = 468, RuleCaseSpecification = 469, RuleSimpleCase = 470, 
    RuleSearchedCase = 471, RuleSimpleWhenClause = 472, RuleSearchedWhenClause = 473, 
    RuleElseClause = 474, RuleCaseOperand = 475, RuleWhenOperandList = 476, 
    RuleWhenOperand = 477, RuleResult = 478, RuleResultExpression = 479, 
    RuleCastSpecification = 480, RuleCastOperand = 481, RuleCastTarget = 482, 
    RuleAggregateFunction = 483, RuleGeneralSetFunction = 484, RuleBinarySetFunction = 485, 
    RuleGeneralSetFunctionType = 486, RuleSetQuantifier = 487, RuleBinarySetFunctionType = 488, 
    RuleDependentValueExpression = 489, RuleIndependentValueExpression = 490, 
    RuleElement_idFunction = 491, RuleBindingVariableReference = 492, RulePathValueExpression = 493, 
    RulePathValueConstructor = 494, RulePathValueConstructorByEnumeration = 495, 
    RulePathElementList = 496, RulePathElementListStart = 497, RulePathElementListStep = 498, 
    RuleListValueExpression = 499, RuleListValueFunction = 500, RuleTrimListFunction = 501, 
    RuleElementsFunction = 502, RuleListValueConstructor = 503, RuleListValueConstructorByEnumeration = 504, 
    RuleListElementList = 505, RuleListElement = 506, RuleRecordConstructor = 507, 
    RuleFieldsSpecification = 508, RuleFieldList = 509, RuleField = 510, 
    RuleTruthValue = 511, RuleNumericValueExpression = 512, RuleNumericValueFunction = 513, 
    RuleLengthExpression = 514, RuleCardinalityExpression = 515, RuleCardinalityExpressionArgument = 516, 
    RuleCharLengthExpression = 517, RuleByteLengthExpression = 518, RulePathLengthExpression = 519, 
    RuleAbsoluteValueExpression = 520, RuleModulusExpression = 521, RuleNumericValueExpressionDividend = 522, 
    RuleNumericValueExpressionDivisor = 523, RuleTrigonometricFunction = 524, 
    RuleTrigonometricFunctionName = 525, RuleGeneralLogarithmFunction = 526, 
    RuleGeneralLogarithmBase = 527, RuleGeneralLogarithmArgument = 528, 
    RuleCommonLogarithm = 529, RuleNaturalLogarithm = 530, RuleExponentialFunction = 531, 
    RulePowerFunction = 532, RuleNumericValueExpressionBase = 533, RuleNumericValueExpressionExponent = 534, 
    RuleSquareRoot = 535, RuleFloorFunction = 536, RuleCeilingFunction = 537, 
    RuleCharacterStringValueExpression = 538, RuleByteStringValueExpression = 539, 
    RuleTrimOperands = 540, RuleTrimCharacterOrByteStringSource = 541, RuleTrimSpecification = 542, 
    RuleTrimCharacterOrByteString = 543, RuleNormalForm = 544, RuleStringLength = 545, 
    RuleDatetimeValueExpression = 546, RuleDatetimeValueFunction = 547, 
    RuleDateFunction = 548, RuleTimeFunction = 549, RuleLocaltimeFunction = 550, 
    RuleDatetimeFunction = 551, RuleLocaldatetimeFunction = 552, RuleDateFunctionParameters = 553, 
    RuleTimeFunctionParameters = 554, RuleDatetimeFunctionParameters = 555, 
    RuleDurationValueExpression = 556, RuleDatetimeSubtraction = 557, RuleDatetimeSubtractionParameters = 558, 
    RuleDatetimeValueExpression1 = 559, RuleDatetimeValueExpression2 = 560, 
    RuleDurationValueFunction = 561, RuleDurationFunction = 562, RuleDurationFunctionParameters = 563, 
    RuleObjectName = 564, RuleObjectNameOrBindingVariable = 565, RuleDirectoryName = 566, 
    RuleSchemaName = 567, RuleGraphName = 568, RuleDelimitedGraphName = 569, 
    RuleGraphTypeName = 570, RuleNodeTypeName = 571, RuleEdgeTypeName = 572, 
    RuleBindingTableName = 573, RuleDelimitedBindingTableName = 574, RuleProcedureName = 575, 
    RuleLabelName = 576, RulePropertyName = 577, RuleFieldName = 578, RuleElementVariable = 579, 
    RulePathVariable = 580, RuleSubpathVariable = 581, RuleBindingVariable = 582, 
    RuleUnsignedLiteral = 583, RuleGeneralLiteral = 584, RuleTemporalLiteral = 585, 
    RuleDateLiteral = 586, RuleTimeLiteral = 587, RuleDatetimeLiteral = 588, 
    RuleListLiteral = 589, RuleRecordLiteral = 590, RuleIdentifier = 591, 
    RuleRegularIdentifier = 592, RuleTimeZoneString = 593, RuleCharacterStringLiteral = 594, 
    RuleUnsignedNumericLiteral = 595, RuleExactNumericLiteral = 596, RuleApproximateNumericLiteral = 597, 
    RuleUnsignedInteger = 598, RuleUnsignedDecimalInteger = 599, RuleNullLiteral = 600, 
    RuleDateString = 601, RuleTimeString = 602, RuleDatetimeString = 603, 
    RuleDurationLiteral = 604, RuleDurationString = 605, RuleNodeSynonym = 606, 
    RuleEdgesSynonym = 607, RuleEdgeSynonym = 608, RuleNonReservedWords = 609
  };
