...
public:
  ...
  enum {
    RuleGqlProgram = 0, RuleShowCommand = 1, RuleExplainCommand = 2, RuleProgramActivity = 3, 
    RuleSessionActivity = 4, RuleTransactionActivity = 5, RuleEndTransactionCommand = 6, 
    ...
    RuleSessionSetQueryLangClause = 17, RuleSetQueryLangValue = 18, RuleQueryLangString = 19, 
    RuleSessionResetCommand = 20, RuleSessionResetArguments = 21, RuleSessionCloseCommand = 22, 
    RuleSessionParameterSpecification = 23, RuleStartTransactionCommand = 24, 
    RuleTransactionCharacteristics = 25, RuleTransactionMode = 26, RuleTransactionAccessMode = 27, 
    RuleRollbackCommand = 28, RuleCommitCommand = 29, RuleNestedProcedureSpecification = 30, 
    RuleProcedureSpecification = 31, RuleNestedDataModifyingProcedureSpecification = 32, 
    RuleNestedQuerySpecification = 33, RuleProcedureBody = 34, RuleBindingVariableDefinitionBlock = 35, 
    RuleBindingVariableDefinition = 36, RuleStatementBlock = 37, RuleStatement = 38, 
    RuleNextStatement = 39, RuleGraphVariableDefinition = 40, RuleOptTypedGraphInitializer = 41, 
    RuleGraphInitializer = 42, RuleBindingTableVariableDefinition = 43, 
    RuleOptTypedBindingTableInitializer = 44, RuleBindingTableInitializer = 45, 
    RuleValueVariableDefinition = 46, RuleOptTypedValueInitializer = 47, 
    RuleValueInitializer = 48, RuleGraphExpression = 49, RuleCurrentGraph = 50, 
    RuleBindingTableExpression = 51, RuleNestedBindingTableQuerySpecification = 52, 
    RuleObjectExpressionPrimary = 53, RuleLinearCatalogModifyingStatement = 54, 
    RuleSimpleCatalogModifyingStatement = 55, RulePrimitiveCatalogModifyingStatement = 56, 
    RuleCreateSchemaStatement = 57, RuleDropSchemaStatement = 58, RuleCreateGraphStatement = 59, 
    RulePropertyGraphContent = 60, RulePgq_propertyGraphContent = 61, RulePgq_nodeTables = 62, 
    RulePgq_edgeTables = 63, RulePgq_elementList = 64, RulePgq_element = 65, 
    RulePgq_Alias = 66, RulePgq_catalogObjectParentReference = 67, RulePgq_elementName = 68, 
    RulePgq_elementKeys = 69, RulePgq_nodeElementKey = 70, RulePgq_edgeElementKeys = 71, 
    RulePgq_elementKey = 72, RulePgq_sourceKey = 73, RulePgq_destinationKey = 74, 
    RulePgq_edgeColumnNameList = 75, RulePgq_nodeColumnNameList = 76, RulePgq_columnNameList = 77, 
    RulePgq_columnName = 78, RulePgq_elementAliasReference = 79, RulePgq_labelAndPropertiesList = 80, 
    RulePgq_labelAndProperties = 81, RulePgq_elementLabel = 82, RulePgq_elementProperties = 83, 
    RulePgq_propertiesAre = 84, RulePgq_derivedPropertyList = 85, RulePgg_derivedProperty = 86, 
    RulePgq_dynamicLabel = 87, RulePgq_dynamicLabelColumnName = 88, RulePgq_dynamicProperties = 89, 
    RulePgq_dynamicPropertiesColumnName = 90, RuleOpenGraphType = 91, RuleOfGraphType = 92, 
    RuleGraphTypeLikeGraph = 93, RuleGraphSource = 94, RuleDropGraphStatement = 95, 
    RuleCreateGraphTypeStatement = 96, RuleGraphTypeSource = 97, RuleCopyOfGraphType = 98, 
    RuleDropGraphTypeStatement = 99, RuleCallCatalogModifyingProcedureStatement = 100, 
    RuleLinearDataModifyingStatement = 101, RuleFocusedLinearDataModifyingStatement = 102, 
    RuleFocusedLinearDataModifyingStatementBody = 103, RuleFocusedNestedDataModifyingProcedureSpecification = 104, 
    RuleAmbientLinearDataModifyingStatement = 105, RuleAmbientLinearDataModifyingStatementBody = 106, 
    RuleSimpleLinearDataAccessingStatement = 107, RuleSimpleDataAccessingStatement = 108, 
    RuleSimpleDataModifyingStatement = 109, RulePrimitiveDataModifyingStatement = 110, 
    RuleInsertStatement = 111, RuleSetStatement = 112, RuleSetItemList = 113, 
    RuleSetItem = 114, RuleSetPropertyItem = 115, RuleSetAllPropertiesItem = 116, 
    RuleSetLabelItem = 117, RuleRemoveStatement = 118, RuleRemoveItemList = 119, 
    RuleRemoveItem = 120, RuleRemovePropertyItem = 121, RuleRemoveLabelItem = 122, 
    RuleDeleteStatement = 123, RuleDeleteItemList = 124, RuleDeleteItem = 125, 
    RuleCallDataModifyingProcedureStatement = 126, RuleCompositeQueryStatement = 127, 
    RuleCompositeQueryExpression = 128, RuleCompositeQueryExpressionFocused = 129, 
    RuleCompositeQueryExpressionAmbient = 130, RuleQueryConjunction = 131, 
    RuleSetOperator = 132, RuleCompositeQueryPrimary = 133, RuleLinearQueryStatement = 134, 
    RuleFocusedLinearQueryStatement = 135, RuleFocusedLinearQueryStatementPart = 136, 
    RuleFocusedLinearQueryAndPrimitiveResultStatementPart = 137, RuleFocusedPrimitiveResultStatement = 138, 
    RuleFocusedNestedQuerySpecification = 139, RuleAmbientLinearQueryStatement = 140, 
    RuleSimpleLinearQueryStatement = 141, RuleSimpleQueryStatement = 142, 
    ...
    RuleForStatement = 154, RuleForItem = 155, RuleForItemAlias = 156, RuleForItemSource = 157, 
    RuleForOrdinalityOrOffset = 158, RuleOrderByAndPageStatement = 159, 
    RulePrimitiveResultStatement = 160, RuleReturnStatement = 161, RuleReturnStatementBody = 162, 
    RuleReturnItemList = 163, RuleReturnItem = 164, RuleReturnItemAlias = 165, 
    RuleSelectStatement = 166, RuleSelectItemList = 167, RuleSelectItem = 168, 
    RuleSelectItemAlias = 169, RuleHavingClause = 170, RuleSelectStatementBody = 171, 
    RuleSelectGraphMatchList = 172, RuleSelectGraphMatch = 173, RuleSelectQuerySpecification = 174, 
    RuleCallProcedureStatement = 175, RuleProcedureCall = 176, RuleInlineProcedureCall = 177, 
    RuleVariableScopeClause = 178, RuleBindingVariableReferenceList = 179, 
    RuleNamedProcedureCall = 180, RuleProcedureArgumentList = 181, RuleProcedureArgument = 182, 
    RuleAtSchemaClause = 183, RuleUseGraphClause = 184, RuleGraphPatternBindingTable = 185, 
    RuleGraphPatternYieldClause = 186, RuleGraphPatternYieldItemList = 187, 
    RuleGraphPatternYieldItem = 188, RuleGraphPattern = 189, RuleMatchMode = 190, 
    RuleRepeatableElementsMatchMode = 191, RuleDifferentEdgesMatchMode = 192, 
    RuleElementBindingsOrElements = 193, RuleEdgeBindingsOrEdges = 194, 
    RulePathPatternList = 195, RulePathPattern = 196, RulePathVariableDeclaration = 197, 
    RuleKeepClause = 198, RuleGraphPatternWhereClause = 199, RuleInsertGraphPattern = 200, 
    RuleInsertPathPatternList = 201, RuleInsertPathPattern = 202, RuleInsertNodePattern = 203, 
    RuleInsertEdgePattern = 204, RuleInsertEdgePointingLeft = 205, RuleInsertEdgePointingRight = 206, 
    RuleInsertEdgeUndirected = 207, RuleInsertElementPatternFiller = 208, 
    RuleLabelAndPropertySetSpecification = 209, RulePathPatternPrefix = 210, 
    RulePathModePrefix = 211, RulePathMode = 212, RulePathSearchPrefix = 213, 
    RuleAllPathSearch = 214, RulePathOrPaths = 215, RuleAnyPathSearch = 216, 
    RuleNumberOfPaths = 217, RuleShortestPathSearch = 218, RuleAllShortestPathSearch = 219, 
    RuleAnyShortestPathSearch = 220, RuleCountedShortestPathSearch = 221, 
    RuleCountedShortestGroupSearch = 222, RuleNumberOfGroups = 223, RulePathPatternExpression = 224, 
    RulePathTerm = 225, RulePathFactor = 226, RulePathPrimary = 227, RuleElementPattern = 228, 
    RuleNodePattern = 229, RuleElementPatternFiller = 230, RuleElementVariableDeclaration = 231, 
    RuleIsLabelExpression = 232, RuleIsOrColon = 233, RuleElementPatternPredicate = 234, 
    RuleElementPatternWhereClause = 235, RuleElementPropertySpecification = 236, 
    RulePropertyKeyValuePairList = 237, RulePropertyKeyValuePair = 238, 
    RuleEdgePattern = 239, RuleFullEdgePattern = 240, RuleFullEdgePointingLeft = 241, 
    RuleFullEdgeUndirected = 242, RuleFullEdgePointingRight = 243, RuleFullEdgeLeftOrUndirected = 244, 
    RuleFullEdgeUndirectedOrRight = 245, RuleFullEdgeLeftOrRight = 246, 
    RuleFullEdgeAnyDirection = 247, RuleAbbreviatedEdgePattern = 248, RuleParenthesizedPathPatternExpression = 249, 
    RuleSubpathVariableDeclaration = 250, RuleParenthesizedPathPatternWhereClause = 251, 
    RuleLabelExpression = 252, RulePathVariableReference = 253, RuleElementVariableReference = 254, 
    RuleGraphPatternQuantifier = 255, RuleFixedQuantifier = 256, RuleGeneralQuantifier = 257, 
    RuleLowerBound = 258, RuleUpperBound = 259, RuleSimplifiedPathPatternExpression = 260, 
    RuleSimplifiedDefaultingLeft = 261, RuleSimplifiedDefaultingUndirected = 262, 
    RuleSimplifiedDefaultingRight = 263, RuleSimplifiedDefaultingLeftOrUndirected = 264, 
    RuleSimplifiedDefaultingUndirectedOrRight = 265, RuleSimplifiedDefaultingLeftOrRight = 266, 
    RuleSimplifiedDefaultingAnyDirection = 267, RuleSimplifiedContents = 268, 
    RuleSimplifiedPathUnion = 269, RuleSimplifiedMultisetAlternation = 270, 
    RuleSimplifiedTerm = 271, RuleSimplifiedFactorLow = 272, RuleSimplifiedFactorHigh = 273, 
    RuleSimplifiedQuantified = 274, RuleSimplifiedQuestioned = 275, RuleSimplifiedTertiary = 276, 
    RuleSimplifiedDirectionOverride = 277, RuleSimplifiedOverrideLeft = 278, 
    RuleSimplifiedOverrideUndirected = 279, RuleSimplifiedOverrideRight = 280, 
    RuleSimplifiedOverrideLeftOrUndirected = 281, RuleSimplifiedOverrideUndirectedOrRight = 282, 
    RuleSimplifiedOverrideLeftOrRight = 283, RuleSimplifiedOverrideAnyDirection = 284, 
    RuleSimplifiedSecondary = 285, RuleSimplifiedNegation = 286, RuleSimplifiedPrimary = 287, 
    RuleWhereClause = 288, RuleYieldClause = 289, RuleYieldItemList = 290, 
    RuleYieldItem = 291, RuleYieldItemName = 292, RuleYieldItemAlias = 293, 
    RuleGroupByClause = 294, RuleGroupingElementList = 295, RuleGroupingElement = 296, 
    RuleEmptyGroupingSet = 297, RuleOrderByClause = 298, RuleSortSpecificationList = 299, 
    RuleSortSpecification = 300, RuleSortKey = 301, RuleOrderingSpecification = 302, 
    RuleNullOrdering = 303, RuleLimitClause = 304, RuleOffsetClause = 305, 
    RuleOffsetSynonym = 306, RuleSchemaReference = 307, RuleAbsoluteCatalogSchemaReference = 308, 
    RuleCatalogSchemaParentAndName = 309, RuleRelativeCatalogSchemaReference = 310, 
    RulePredefinedSchemaReference = 311, RuleAbsoluteDirectoryPath = 312, 
    RuleRelativeDirectoryPath = 313, RuleSimpleDirectoryPath = 314, RuleGraphReference = 315, 
    RuleCatalogGraphParentAndName = 316, RuleHomeGraph = 317, RuleGraphTypeReference = 318, 
    RuleCatalogGraphTypeParentAndName = 319, RuleBindingTableReference = 320, 
    RuleProcedureReference = 321, RuleCatalogProcedureParentAndName = 322, 
    RuleCatalogObjectParentReference = 323, RuleReferenceParameterSpecification = 324, 
    RuleNestedGraphTypeSpecification = 325, RuleGraphTypeSpecificationBody = 326, 
    RuleElementTypeList = 327, RuleElementTypeSpecification = 328, RuleNodeTypeSpecification = 329, 
    RuleNodeTypePattern = 330, RuleNodeTypePhrase = 331, RuleNodeTypePhraseFiller = 332, 
    RuleNodeTypeFiller = 333, RuleLocalNodeTypeAlias = 334, RuleNodeTypeImpliedContent = 335, 
    RuleNodeTypeKeyLabelSet = 336, RuleNodeTypeLabelSet = 337, RuleNodeTypePropertyTypes = 338, 
    RuleEdgeTypeSpecification = 339, RuleEdgeTypePattern = 340, RuleEdgeTypePhrase = 341, 
    RuleEdgeTypePhraseFiller = 342, RuleEdgeTypeFiller = 343, RuleEdgeTypeImpliedContent = 344, 
    RuleEdgeTypeKeyLabelSet = 345, RuleEdgeTypeLabelSet = 346, RuleEdgeTypePropertyTypes = 347, 
    RuleEdgeTypePatternDirected = 348, RuleEdgeTypePatternPointingRight = 349, 
    RuleEdgeTypePatternPointingLeft = 350, RuleEdgeTypePatternUndirected = 351, 
    RuleArcTypePointingRight = 352, RuleArcTypePointingLeft = 353, RuleArcTypeUndirected = 354, 
    RuleSourceNodeTypeReference = 355, RuleDestinationNodeTypeReference = 356, 
    RuleEdgeKind = 357, RuleEndpointPairPhrase = 358, RuleEndpointPair = 359, 
    RuleEndpointPairDirected = 360, RuleEndpointPairPointingRight = 361, 
    RuleEndpointPairPointingLeft = 362, RuleEndpointPairUndirected = 363, 
    RuleConnectorPointingRight = 364, RuleConnectorUndirected = 365, RuleSourceNodeTypeAlias = 366, 
    RuleDestinationNodeTypeAlias = 367, RuleLabelSetPhrase = 368, RuleLabelSetSpecification = 369, 
    RulePropertyTypesSpecification = 370, RulePropertyTypeList = 371, RulePropertyType = 372, 
    RulePropertyValueType = 373, RuleBindingTableType = 374, RuleValueType = 375, 
    RuleTyped = 376, RulePredefinedType = 377, RuleBooleanType = 378, RuleCharacterStringType = 379, 
    RuleByteStringType = 380, RuleMinLength = 381, RuleMaxLength = 382, 
    RuleFixedLength = 383, RuleNumericType = 384, RuleExactNumericType = 385, 
    RuleBinaryExactNumericType = 386, RuleSignedBinaryExactNumericType = 387, 
    RuleUnsignedBinaryExactNumericType = 388, RuleVerboseBinaryExactNumericType = 389, 
    RuleDecimalExactNumericType = 390, RulePrecision = 391, RuleScale = 392, 
    RuleApproximateNumericType = 393, RuleTemporalType = 394, RuleTemporalInstantType = 395, 
    RuleDatetimeType = 396, RuleLocaldatetimeType = 397, RuleDateType = 398, 
    RuleTimeType = 399, RuleLocaltimeType = 400, RuleTemporalDurationType = 401, 
    RuleTemporalDurationQualifier = 402, RuleReferenceValueType = 403, RuleImmaterialValueType = 404, 
    RuleNullType = 405, RuleEmptyType = 406, RuleGraphReferenceValueType = 407, 
    RuleClosedGraphReferenceValueType = 408, RuleOpenGraphReferenceValueType = 409, 
    RuleBindingTableReferenceValueType = 410, RuleNodeReferenceValueType = 411, 
    RuleClosedNodeReferenceValueType = 412, RuleOpenNodeReferenceValueType = 413, 
    RuleEdgeReferenceValueType = 414, RuleClosedEdgeReferenceValueType = 415, 
    RuleOpenEdgeReferenceValueType = 416, RulePathValueType = 417, RuleListValueTypeName = 418, 
    RuleListValueTypeNameSynonym = 419, RuleRecordType = 420, RuleFieldTypesSpecification = 421, 
    RuleFieldTypeList = 422, RuleNotNull = 423, RuleFieldType = 424, RuleSearchCondition = 425, 
    RulePredicate = 426, RuleCompOp = 427, RuleExistsPredicate = 428, RuleNullPredicate = 429, 
    RuleNullPredicatePart2 = 430, RuleValueTypePredicate = 431, RuleValueTypePredicatePart2 = 432, 
    RuleNormalizedPredicatePart2 = 433, RuleDirectedPredicate = 434, RuleDirectedPredicatePart2 = 435, 
    RuleLabeledPredicate = 436, RuleLabeledPredicatePart2 = 437, RuleIsLabeledOrColon = 438, 
    RuleSourceDestinationPredicate = 439, RuleNodeReference = 440, RuleSourcePredicatePart2 = 441, 
    RuleDestinationPredicatePart2 = 442, RuleEdgeReference = 443, RuleAll_differentPredicate = 444, 
    RuleSamePredicate = 445, RuleProperty_existsPredicate = 446, RuleValueExpression = 447, 
    RuleValueFunction = 448, RuleBooleanValueExpression = 449, RuleCharacterOrByteStringFunction = 450, 
    RuleSubCharacterOrByteString = 451, RuleTrimSingleCharacterOrByteString = 452, 
    RuleFoldCharacterString = 453, RuleTrimMultiCharacterCharacterString = 454, 
    RuleNormalizeCharacterString = 455, RuleNodeReferenceValueExpression = 456, 
    RuleEdgeReferenceValueExpression = 457, RuleAggregatingValueExpression = 458, 
    RuleValueExpressionPrimary = 459, RuleExtentedFunction = 460, RuleExtractFunction = 461, 
    RuleExtract_list = 462, RuleExtract_arg = 463, RuleHeadFunction = 464, 
    RuleLastFunction = 465, RuleToTimeStampFunction = 466, RuleParenthesizedValueExpression = 467, 
    RuleNonParenthesizedValueExpressionPrimary = 468, RuleNonParenthesizedValueExpressionPrimarySpecialCase = 469, 
    RuleUnsignedValueSpecification = 470, RuleNonNegativeIntegerSpecification = 471, 
    RuleGeneralValueSpecification = 472, RuleDynamicParameterSpecification = 473, 
    RuleLetValueExpression = 474, RuleValueQueryExpression = 475, RuleCaseExpression = 476, 
    RuleCaseAbbreviation = 477, RuleCaseSpecification = 478, RuleSimpleCase = 479, 
    RuleSearchedCase = 480, RuleSimpleWhenClause = 481, RuleSearchedWhenClause = 482, 
    RuleElseClause = 483, RuleCaseOperand = 484, RuleWhenOperandList = 485, 
    RuleWhenOperand = 486, RuleResult = 487, RuleResultExpression = 488, 
    RuleCastSpecification = 489, RuleCastOperand = 490, RuleCastTarget = 491, 
    RuleAggregateFunction = 492, RuleGeneralSetFunction = 493, RuleBinarySetFunction = 494, 
    RuleGeneralSetFunctionType = 495, RuleSetQuantifier = 496, RuleBinarySetFunctionType = 497, 
    RuleDependentValueExpression = 498, RuleIndependentValueExpression = 499, 
    RuleElement_idFunction = 500, RuleBindingVariableReference = 501, RulePathValueExpression = 502, 
    RulePathValueConstructor = 503, RulePathValueConstructorByEnumeration = 504, 
    RulePathElementList = 505, RulePathElementListStart = 506, RulePathElementListStep = 507, 
    RuleListValueExpression = 508, RuleListValueFunction = 509, RuleLambdaFunction = 510, 
    RuleTrimListFunction = 511, RuleElementsFunction = 512, RuleListContainsFunction = 513, 
    RuleTransformLambdaFunction = 514, RuleFilterLambdaFunction = 515, RuleReduceLambdaFunction = 516, 
    RuleLambdaExpression = 517, RuleLambdaParameterNameList = 518, RuleLambdaParameterName = 519, 
    RuleListValueConstructor = 520, RuleListValueConstructorByEnumeration = 521, 
    RuleListElementList = 522, RuleListElement = 523, RuleRecordConstructor = 524, 
    RuleFieldsSpecification = 525, RuleFieldList = 526, RuleField = 527, 
    RuleTruthValue = 528, RuleNumericValueExpression = 529, RuleNumericValueFunction = 530, 
    RuleLengthExpression = 531, RuleCardinalityExpression = 532, RuleCardinalityExpressionArgument = 533, 
    RuleCharLengthExpression = 534, RuleByteLengthExpression = 535, RulePathLengthExpression = 536, 
    RuleAbsoluteValueExpression = 537, RuleModulusExpression = 538, RuleNumericValueExpressionDividend = 539, 
    RuleNumericValueExpressionDivisor = 540, RuleTrigonometricFunction = 541, 
    RuleTrigonometricFunctionName = 542, RuleGeneralLogarithmFunction = 543, 
    RuleGeneralLogarithmBase = 544, RuleGeneralLogarithmArgument = 545, 
    RuleCommonLogarithm = 546, RuleNaturalLogarithm = 547, RuleExponentialFunction = 548, 
    RulePowerFunction = 549, RuleNumericValueExpressionBase = 550, RuleNumericValueExpressionExponent = 551, 
    RuleSquareRoot = 552, RuleFloorFunction = 553, RuleCeilingFunction = 554, 
    RuleCharacterStringValueExpression = 555, RuleByteStringValueExpression = 556, 
    RuleTrimOperands = 557, RuleTrimCharacterOrByteStringSource = 558, RuleTrimSpecification = 559, 
    RuleTrimCharacterOrByteString = 560, RuleNormalForm = 561, RuleStringLength = 562, 
    RuleDatetimeValueExpression = 563, RuleDatetimeValueFunction = 564, 
    RuleDateFunction = 565, RuleTimeFunction = 566, RuleLocaltimeFunction = 567, 
    RuleDatetimeFunction = 568, RuleLocaldatetimeFunction = 569, RuleDateFunctionParameters = 570, 
    RuleTimeFunctionParameters = 571, RuleDatetimeFunctionParameters = 572, 
    RuleDurationValueExpression = 573, RuleDatetimeSubtraction = 574, RuleDatetimeSubtractionParameters = 575, 
    RuleDatetimeValueExpression1 = 576, RuleDatetimeValueExpression2 = 577, 
    RuleDurationValueFunction = 578, RuleDurationFunction = 579, RuleDurationFunctionParameters = 580, 
    RuleObjectName = 581, RuleObjectNameOrBindingVariable = 582, RuleDirectoryName = 583, 
    RuleSchemaName = 584, RuleGraphName = 585, RuleDelimitedGraphName = 586, 
    RuleGraphTypeName = 587, RuleNodeTypeName = 588, RuleEdgeTypeName = 589, 
    RuleBindingTableName = 590, RuleDelimitedBindingTableName = 591, RuleProcedureName = 592, 
    RuleLabelName = 593, RulePropertyName = 594, RuleFieldName = 595, RuleElementVariable = 596, 
    RulePathVariable = 597, RuleSubpathVariable = 598, RuleBindingVariable = 599, 
    RuleUnsignedLiteral = 600, RuleGeneralLiteral = 601, RuleTemporalLiteral = 602, 
    RuleDateLiteral = 603, RuleTimeLiteral = 604, RuleDatetimeLiteral = 605, 
    RuleListLiteral = 606, RuleRecordLiteral = 607, RuleIdentifier = 608, 
    RuleRegularIdentifier = 609, RuleTimeZoneString = 610, RuleCharacterStringLiteral = 611, 
    RuleUnsignedNumericLiteral = 612, RuleExactNumericLiteral = 613, RuleApproximateNumericLiteral = 614, 
    RuleUnsignedInteger = 615, RuleUnsignedDecimalInteger = 616, RuleNullLiteral = 617, 
    RuleDateString = 618, RuleTimeString = 619, RuleDatetimeString = 620, 
    RuleDurationLiteral = 621, RuleDurationString = 622, RuleNodeSynonym = 623, 
    RuleEdgesSynonym = 624, RuleEdgeSynonym = 625, RuleNonReservedWords = 626
  };
  ...
  class PropertyGraphContentContext;
  class Pgq_propertyGraphContentContext;
  class Pgq_nodeTablesContext;
  class Pgq_edgeTablesContext;
  class Pgq_elementListContext;
  class Pgq_elementContext;
  class Pgq_AliasContext;
  class Pgq_catalogObjectParentReferenceContext;
  class Pgq_elementNameContext;
  class Pgq_elementKeysContext;
  class Pgq_nodeElementKeyContext;
  class Pgq_edgeElementKeysContext;
  class Pgq_elementKeyContext;
  class Pgq_sourceKeyContext;
  class Pgq_destinationKeyContext;
  class Pgq_edgeColumnNameListContext;
  class Pgq_nodeColumnNameListContext;
  class Pgq_columnNameListContext;
  class Pgq_columnNameContext;
  class Pgq_elementAliasReferenceContext;
  class Pgq_labelAndPropertiesListContext;
  class Pgq_labelAndPropertiesContext;
  class Pgq_elementLabelContext;
  class Pgq_elementPropertiesContext;
  class Pgq_propertiesAreContext;
  class Pgq_derivedPropertyListContext;
  class Pgg_derivedPropertyContext;
  class Pgq_dynamicLabelContext;
  class Pgq_dynamicLabelColumnNameContext;
  class Pgq_dynamicPropertiesContext;
  class Pgq_dynamicPropertiesColumnNameContext;
  ...
  class ExtentedFunctionContext;
  class ExtractFunctionContext;
  class Extract_listContext;
  class Extract_argContext;
  class HeadFunctionContext;
  class LastFunctionContext;
  class ToTimeStampFunctionContext;
  ...
  public:
    ...
    ShowCommandContext() = default;
    void copyFrom(ShowCommandContext *context);
  ...
  class  ShowCurrentGraphContext : public ShowCommandContext {
  public:
    ShowCurrentGraphContext(ShowCommandContext *ctx);

    antlr4::tree::TerminalNode *SHOW();
    antlr4::tree::TerminalNode *CURRENT_GRAPH();
  };

  class  ShowCreateGraphContext : public ShowCommandContext {
  public:
    ShowCreateGraphContext(ShowCommandContext *ctx);
  ...
  class  ShowGraphsContext : public ShowCommandContext {
  public:
    ShowGraphsContext(ShowCommandContext *ctx);

    antlr4::tree::TerminalNode *SHOW();
    antlr4::tree::TerminalNode *GRAPHS();
  };
  ...
  public:
    ...
    PropertyGraphContentContext *propertyGraphContent();
    Pgq_propertyGraphContentContext *pgq_propertyGraphContent();
    antlr4::tree::TerminalNode *PROPERTY();
    antlr4::tree::TerminalNode *IF();
    antlr4::tree::TerminalNode *NOT();
    antlr4::tree::TerminalNode *EXISTS();
  ...
  class  PropertyGraphContentContext : public antlr4::ParserRuleContext {
  public:
    PropertyGraphContentContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  Pgq_propertyGraphContentContext : public antlr4::ParserRuleContext {
  public:
    Pgq_propertyGraphContentContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Pgq_nodeTablesContext *pgq_nodeTables();
    Pgq_edgeTablesContext *pgq_edgeTables();
  ...
  class  Pgq_nodeTablesContext : public antlr4::ParserRuleContext {
  public:
    Pgq_nodeTablesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *NODE();
    antlr4::tree::TerminalNode *TABLES();
    Pgq_elementListContext *pgq_elementList();
  ...
  class  Pgq_edgeTablesContext : public antlr4::ParserRuleContext {
  public:
    Pgq_edgeTablesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  Pgq_elementListContext : public antlr4::ParserRuleContext {
  public:
    Pgq_elementListContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *LEFT_PAREN();
    std::vector<Pgq_elementContext *> pgq_element();
    Pgq_elementContext* pgq_element(size_t i);
  ...
  class  Pgq_elementContext : public antlr4::ParserRuleContext {
  public:
    Pgq_elementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Pgq_elementNameContext *pgq_elementName();
    Pgq_elementKeysContext *pgq_elementKeys();
    antlr4::tree::TerminalNode *AS();
    Pgq_AliasContext *pgq_Alias();
    Pgq_labelAndPropertiesListContext *pgq_labelAndPropertiesList();
    Pgq_elementPropertiesContext *pgq_elementProperties();
    Pgq_dynamicLabelContext *pgq_dynamicLabel();
    Pgq_dynamicPropertiesContext *pgq_dynamicProperties();

   
  };

  Pgq_elementContext* pgq_element();

  class  Pgq_AliasContext : public antlr4::ParserRuleContext {
  public:
    Pgq_AliasContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  Pgq_catalogObjectParentReferenceContext : public antlr4::ParserRuleContext {
  public:
    Pgq_catalogObjectParentReferenceContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  Pgq_catalogObjectParentReferenceContext* pgq_catalogObjectParentReference();

  class  Pgq_elementNameContext : public antlr4::ParserRuleContext {
  public:
    Pgq_elementNameContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    IdentifierContext *identifier();
    Pgq_catalogObjectParentReferenceContext *pgq_catalogObjectParentReference();
  ...
  class  Pgq_elementKeysContext : public antlr4::ParserRuleContext {
  public:
    Pgq_elementKeysContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Pgq_nodeElementKeyContext *pgq_nodeElementKey();
    Pgq_edgeElementKeysContext *pgq_edgeElementKeys();
  ...
  class  Pgq_nodeElementKeyContext : public antlr4::ParserRuleContext {
  public:
    Pgq_nodeElementKeyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Pgq_elementKeyContext *pgq_elementKey();
  ...
  class  Pgq_edgeElementKeysContext : public antlr4::ParserRuleContext {
  public:
    Pgq_edgeElementKeysContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Pgq_sourceKeyContext *pgq_sourceKey();
    Pgq_destinationKeyContext *pgq_destinationKey();
    Pgq_elementKeyContext *pgq_elementKey();
  ...
  class  Pgq_elementKeyContext : public antlr4::ParserRuleContext {
  public:
    Pgq_elementKeyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *KEY();
    Pgq_columnNameListContext *pgq_columnNameList();
  ...
  class  Pgq_sourceKeyContext : public antlr4::ParserRuleContext {
  public:
    Pgq_sourceKeyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *SOURCE();
    antlr4::tree::TerminalNode *KEY();
    Pgq_edgeColumnNameListContext *pgq_edgeColumnNameList();
    antlr4::tree::TerminalNode *REFERENCES();
    Pgq_elementAliasReferenceContext *pgq_elementAliasReference();
    Pgq_nodeColumnNameListContext *pgq_nodeColumnNameList();
  ...
  class  Pgq_destinationKeyContext : public antlr4::ParserRuleContext {
  public:
    Pgq_destinationKeyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  Pgq_edgeColumnNameListContext : public antlr4::ParserRuleContext {
  public:
    Pgq_edgeColumnNameListContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Pgq_columnNameListContext *pgq_columnNameList();
  ...
  class  Pgq_nodeColumnNameListContext : public antlr4::ParserRuleContext {
  public:
    Pgq_nodeColumnNameListContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Pgq_columnNameListContext *pgq_columnNameList();
  ...
  class  Pgq_columnNameListContext : public antlr4::ParserRuleContext {
  public:
    Pgq_columnNameListContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *LEFT_PAREN();
    std::vector<Pgq_columnNameContext *> pgq_columnName();
    Pgq_columnNameContext* pgq_columnName(size_t i);
    antlr4::tree::TerminalNode *RIGHT_PAREN();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  class  Pgq_columnNameContext : public antlr4::ParserRuleContext {
  public:
    Pgq_columnNameContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    IdentifierContext *identifier();
  ...
  Pgq_columnNameContext* pgq_columnName();

  class  Pgq_elementAliasReferenceContext : public antlr4::ParserRuleContext {
  public:
    Pgq_elementAliasReferenceContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    IdentifierContext *identifier();
  ...
  class  Pgq_labelAndPropertiesListContext : public antlr4::ParserRuleContext {
  public:
    Pgq_labelAndPropertiesListContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<Pgq_labelAndPropertiesContext *> pgq_labelAndProperties();
    Pgq_labelAndPropertiesContext* pgq_labelAndProperties(size_t i);
  ...
  class  Pgq_labelAndPropertiesContext : public antlr4::ParserRuleContext {
  public:
    Pgq_labelAndPropertiesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Pgq_elementLabelContext *pgq_elementLabel();
    Pgq_elementPropertiesContext *pgq_elementProperties();

   
  };

  Pgq_labelAndPropertiesContext* pgq_labelAndProperties();

  class  Pgq_elementLabelContext : public antlr4::ParserRuleContext {
  public:
    Pgq_elementLabelContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  Pgq_elementPropertiesContext : public antlr4::ParserRuleContext {
  public:
    Pgq_elementPropertiesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *NO();
    antlr4::tree::TerminalNode *PROPERTIES();
    Pgq_propertiesAreContext *pgq_propertiesAre();
    Pgq_derivedPropertyListContext *pgq_derivedPropertyList();
  ...
  class  Pgq_propertiesAreContext : public antlr4::ParserRuleContext {
  public:
    Pgq_propertiesAreContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *PROPERTIES();
    antlr4::tree::TerminalNode *ALL();
  ...
  class  Pgq_derivedPropertyListContext : public antlr4::ParserRuleContext {
  public:
    Pgq_derivedPropertyListContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *PROPERTIES();
    antlr4::tree::TerminalNode *LEFT_PAREN();
    std::vector<Pgg_derivedPropertyContext *> pgg_derivedProperty();
    Pgg_derivedPropertyContext* pgg_derivedProperty(size_t i);
    antlr4::tree::TerminalNode *RIGHT_PAREN();
    std::vector<antlr4::tree::TerminalNode *> COMMA();
    antlr4::tree::TerminalNode* COMMA(size_t i);
  ...
  class  Pgg_derivedPropertyContext : public antlr4::ParserRuleContext {
  public:
    Pgg_derivedPropertyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ValueExpressionContext *valueExpression();
    antlr4::tree::TerminalNode *AS();
  ...
  Pgg_derivedPropertyContext* pgg_derivedProperty();

  class  Pgq_dynamicLabelContext : public antlr4::ParserRuleContext {
  public:
    Pgq_dynamicLabelContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DYNAMIC();
    antlr4::tree::TerminalNode *LABEL();
    antlr4::tree::TerminalNode *LEFT_PAREN();
    Pgq_dynamicLabelColumnNameContext *pgq_dynamicLabelColumnName();
    antlr4::tree::TerminalNode *RIGHT_PAREN();
  ...
  class  Pgq_dynamicLabelColumnNameContext : public antlr4::ParserRuleContext {
  public:
    Pgq_dynamicLabelColumnNameContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    IdentifierContext *identifier();
  ...
  class  Pgq_dynamicPropertiesContext : public antlr4::ParserRuleContext {
  public:
    Pgq_dynamicPropertiesContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DYNAMIC();
    antlr4::tree::TerminalNode *PROPERTIES();
    antlr4::tree::TerminalNode *LEFT_PAREN();
    Pgq_dynamicPropertiesColumnNameContext *pgq_dynamicPropertiesColumnName();
    antlr4::tree::TerminalNode *RIGHT_PAREN();
  ...
  class  Pgq_dynamicPropertiesColumnNameContext : public antlr4::ParserRuleContext {
  public:
    Pgq_dynamicPropertiesColumnNameContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    IdentifierContext *identifier();
  ...
  public:
    ...
    BindingVariableReferenceContext *bindingVariableReference();
    ExtentedFunctionContext *extentedFunction();
    ValueExpressionPrimaryContext *valueExpressionPrimary();
    antlr4::tree::TerminalNode *PERIOD();
    PropertyNameContext *propertyName();
  ...
  class  ExtentedFunctionContext : public antlr4::ParserRuleContext {
  public:
    ExtentedFunctionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ToTimeStampFunctionContext *toTimeStampFunction();
    HeadFunctionContext *headFunction();
    LastFunctionContext *lastFunction();
  ...
  class  HeadFunctionContext : public antlr4::ParserRuleContext {
  public:
    HeadFunctionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  LastFunctionContext : public antlr4::ParserRuleContext {
  public:
    LastFunctionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *LAST();
    antlr4::tree::TerminalNode *LEFT_PAREN();
    ValueExpressionContext *valueExpression();
  ...
  class  ToTimeStampFunctionContext : public antlr4::ParserRuleContext {
  public:
    ToTimeStampFunctionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
